// internal/seller-service/config/config.go
...
func Read() Config {
	...
	// Bu dosyanın kendi klasörünü al (internal/seller-service/config)
...
func getCurrentConfigDir() string {
	...
	return filepath.Dir(file) // ← bu dosyanın olduğu klasör: internal/seller-service/config
}
