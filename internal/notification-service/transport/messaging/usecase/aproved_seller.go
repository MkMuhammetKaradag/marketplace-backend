...
func NewApproveSellerUseCase(emailProvider domain.EmailProvider, notificationRepository domain.NotificationRepository) ApproveSellerUseCase {
...
func (u *approveSellerUseCase) Execute(ctx context.Context, userID uuid.UUID) error {
    ...
    <body>
        <div class="container">
            <div class="header">
                <h2>Satıcı isteğiniz Onaylandı! 📦</h2>
            </div>
            <div class="content">
                <p>Merhaba <strong>%s</strong>,</p>
                <p>Satıcı isteğiniz onaylandı.</p>

                <div class="seller-details">
                     <p>Artık ürünlerinizi satabilirsiniz.</p>
                </div>
